...
- **파일**: `src/commons/providers/auth/auth.guard.tsx`
- **목적**: 페이지별 권한 검증 및 리다이렉션
- **기능**:
...
1. **인증 가드 완성**: 페이지별 권한 검증 시스템 완료
2. **일기 상세 기능**: 일기 상세 페이지 및 CRUD 기능 구현
3. **API 연동**: GraphQL 쿼리 및 뮤테이션 구현
